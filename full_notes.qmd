...
```{=latex}
\begin{center}\textit{Meta K-Type}\end{center}
\noindent
\begin{minipage}[t]{0.46\textwidth}
\vspace{0pt}
\begin{center}
$\uparrow$\\[0.2em]
{\large\textbf{Chunking Up}}\\[0.2em]
Agreement
\end{center}
\textbf{"What is this an Example of?"}\\
\textbf{"For What Purpose...?"}\\
\textbf{"What is your intention...?"}

\vspace{0.6em}
In Mediation, chunk up to get agreement. Chunk-up until you get a Nominalization.

\vspace{0.6em}
\underline{\textbf{The Structure of Intuition:}} The ability to chunk-up to find connections \& relationships, and then to chunk back down \& relate to the current situation. It's rare to find a large chunker who sorts for information --- they are usually small chunkers.

\vspace{0.6em}
\textbf{"What are examples of this?"}\\
\textbf{"What specifically...?"}\\
--- any Meta Model Question

\vfill
\begin{center}
{\large\textbf{Details \& Distinctions}}\\[0.2em]
{\large\textbf{Chunking Down}}\\[0.2em]
$\downarrow$
\end{center}
\end{minipage}%
\hfill
...
\vspace{0pt}
\includegraphics[width=\linewidth]{assets/hierarchy_tree.jpg}
\end{minipage}
```
